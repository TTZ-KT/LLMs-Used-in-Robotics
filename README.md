...
* [1. Planning & Reasoning](#1-planning--reasoning)
...
*Core question: "How does the robot decide WHAT to do and plan HOW to do it?"*

This category includes task decomposition, reasoning, motion planning, and replanning.
...
*Core question: "How does the robot PHYSICALLY interact with objects?"*
...
Safety is critical. Robots must avoid hurting people, breaking things, and getting stuck. LLMs help by predicting dangers, explaining risks, and recovering from mistakes. This category also includes benchmarks, simulation frameworks, and human-robot interaction.
